...
const Welcome = () => {
    ...
    return (
        <>
            <div className='flex-1 bg-gradient-to-b from-red-400 to-red-500 flex flex-col items-center justify-center text-center p-8 welcome'>
                ...
                <p className='text-white text-lg md:text-xl mb-4 font-semibold'>
                    We've missed you! Log in now to reconnect with your friends, continue your conversations, and catch up on what you've missed.
                </p>
                <p className='text-white text-lg md:text-xl mb-4 font-semibold'>
            ...
            <div className='animationPart transition-all duration-1000 ease-in-out absolute -top-[100%] left-0 z-10 w-full h-screen'>
                <AuthenticationBlueprint redWhere={"left"} />
            </div>
        </>
    )
}
